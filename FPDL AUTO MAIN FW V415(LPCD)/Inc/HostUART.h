...
#define DEF_WifiFlowChartTimeOutDelay	128		//1s
...
extern void ComPort_SetPost_ExitRemoteUnlcok(void);
extern void ComPort_SetPost_WifiMFT(void);
extern void ComPort_SetPost_MotorSelftest(void);
extern void ComPort_SetPost_OnlinePasswordVerify(uint8_t PasswordBUFF[]);
extern void ComPort_SetPost_PositivePowerOnWifi(void);

extern void ComPort_SetPost_PlayVoice(uint8_t VOICEBUFF[]);
