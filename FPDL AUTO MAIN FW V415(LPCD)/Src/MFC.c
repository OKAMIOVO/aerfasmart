...
#ifdef HardwareDiff_CardReaderUseSPI
//******************************************************************/
//功    能：读RC522寄存器
...
sint8_t PcdReset(void)
{
	...
	||defined (ProjectIs_AutoBarLock_S32Z04) || defined (ProjectIs_AutoBarLock_S61Z03)\
...
#elif defined (ProjectIs_AutoBarLock_S64Z08) || defined (ProjectIs_AutoBarLock_S49Z15)\
	||defined (ProjectIs_AutoBarLock_S64Z09) || defined (ProjectIs_AutoBarLock_S64Z10)\
	||defined (ProjectIs_AutoBarLock_S64Z07) || defined (ProjectIs_AutoBarLock_S64Z04)\
	||defined (ProjectIs_AutoBarLock_S49Z06) || defined (ProjectIs_AutoBarLock_S49Z05)\
	|| defined (ProjectIs_AutoBarLock_S64Z19)|| defined (ProjectIs_AutoBarLock_S78Z01)\
	|| defined (ProjectIs_AutoBarLock_S90Z01) || defined (ProjectIs_AutoBarLock_S90Z11)\
	|| defined (ProjectIs_AutoBarLock_S95Z01)
	WriteRawRC(GsNReg,0x33) 		; 
	WriteRawRC(CWGsCfgReg,0x03) 	; 
	WriteRawRC(ModGsCfgReg,0x03)	; 
		

#elif defined (ProjectIs_AutoBarLock_S06Z04) || defined (ProjectIs_AutoBarLock_S70Z02)\
	...
	WriteRawRC(GsNReg,0xBB) 		; 
	WriteRawRC(CWGsCfgReg,0x2F) 	; 
	WriteRawRC(ModGsCfgReg,0x2F)	; 
  ...
  WriteRawRC(RFCfgReg,0x48)       ; 
	...
	WriteRawRC(GsNReg,0x88) 		; 
	WriteRawRC(CWGsCfgReg,0x1F) 	; 
	WriteRawRC(ModGsCfgReg,0x1F)	; 
	...
	WriteRawRC(GsNReg,0x22) 		; 
	WriteRawRC(CWGsCfgReg,0x02) 	; 
	WriteRawRC(ModGsCfgReg,0x02)	; 
...
Hardware_DelayMs(6);
 ...
 i = 80; //根据时钟频率调整，操作M1等待时间15ms
 do 
 {
   n = ReadRawRC(ComIrqReg);
   i--;
   if (PINMACRO_NFC_IRQ_STATUS == 0x00 )
   	{
   		//PcdAntennaOff();
		return S_SUCCESS;
   	}
...
//		if ( MFC_ReadLockBrandData(TestVal) == S_SUCCESS )
//		{
//			DEBUG_MARK;
//		}
